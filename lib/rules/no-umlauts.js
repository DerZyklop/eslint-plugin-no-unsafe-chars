...
module.exports = function(context) {
    ...
    function isNotAllowed(identifier) {
        return DISALLOWED_VARIABLES.find(function(ident) {
    ...
    function checkForDisallowedCharactersInString(node, identifier) {
        const disallowedChar = isNotAllowed(identifier);
        if (typeof identifier !== "undefined" && !!disallowedChar) {
            context.report(node, `Unexpected umlaut »${disallowedChar}« in »${identifier}«.`);
        }
    }
